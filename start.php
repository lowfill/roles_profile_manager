...
function roles_pm_event_create($event, $type, $entity) {
	...
	$profile_type = new \ColdTrick\ProfileManager\CustomProfileType();
	if ($profile_type->save()) {
		...
		$category = new \ColdTrick\ProfileManager\CustomFieldCategory();
		if ($category->save()) {
			...
			$options = array(
				"type" => "object",
				"subtype" => \ColdTrick\ProfileManager\CustomFieldCategory::SUBTYPE,
				"count" => true,
